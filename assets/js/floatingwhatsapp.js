!(function (e) {
    e.fn.floatingWhatsApp = function (t) {
        var a,
            i,
            o = e.extend(
                {
        ...
        if (
            (l.addClass("floating-wpp-button-image"),
            p.addClass("floating-wpp-button").append(e(o.buttonImage)).css({ width: o.size, height: o.size, "background-color": o.backgroundColor }),
            (!(0 <= (s = window.navigator.userAgent).indexOf("MSIE") || s.match(/Trident.*rv\:11\./)) || o.showOnIE) && p.append(l).appendTo(this),
            p.on("click", function () {
                n && o.showPopup ? C() : v();
            }),
            o.showPopup)
        ) {
            var h = e(document.createElement("textarea")),
                w = e(document.createElement("strong")),
                u = e(
            ...
            function C() {
                c.hasClass("active") || (c.addClass("active"), h.focus());
            }
            c.addClass("floating-wpp-popup"),
                d.addClass("floating-wpp-head"),
                m.addClass("floating-wpp-message"),
                g.addClass("floating-wpp-input-message"),
                r.addClass("floating-wpp-btn-send"),
                m.text(o.popupMessage),
                h.val(o.message),
                o.popupMessage || m.hide(),
                d.append("<span>" + o.headerTitle + "</span>", w).css("background-color", o.headerColor),
                r.append(u),
                g.append(h, r),
                w.addClass("close").html("&times;"),
                c.append(d, m, g).appendTo(this),
                m.click(function () {}),
                w.click(function () {}),
                d.click(function () {
                    c.removeClass("active");
                }),
                h.keypress(function (t) {
                    (o.message = e(this).val()), 13 != t.keyCode || t.shiftKey || n || (t.preventDefault(), r.click());
                }),
                r.click(function () {
                    (o.message = h.val()), v();
                }),
        ...
        function v() {
            var e = "https://";
            (e += n ? "api" : "web"), (e += ".whatsapp.com/send?phone=" + o.phone + "&text=" + encodeURI(o.message)), window.open(e);
        }
        o.zIndex && e(this).css("z-index", o.zIndex), "right" === o.position && (this.css({ left: "auto", right: "15px" }), c.css("right", "0"));
    };
})(jQuery);
